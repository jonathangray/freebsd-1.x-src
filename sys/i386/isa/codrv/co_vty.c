 ...
 *
 *	@(#) $RCSfile: co_vty.c,v $	$Revision: 1.1 $ (Contributed to 386bsd) $Date: 1993/06/12 14:58:01 $
 *
 * This file includes the data table for virtual terminals
 */
static char *rcsid = "$Header: /a/cvs/386BSD/src/sys/i386/isa/codrv/Attic/co_vty.c,v 1.1 1993/06/12 14:58:01 rgrimes Exp $";
