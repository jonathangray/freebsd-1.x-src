 ...
 *
 *	@(#) $RCSfile: co_pc3.c,v $	$Revision: 1.1 $ (Contributed to 386bsd) $Date: 1993/06/12 14:58:02 $
 *
 *	History: see CO_HISTORY
 */
static char *rcsid = "$Header: /a/cvs/386BSD/src/sys/i386/isa/codrv/Attic/co_pc3.c,v 1.1 1993/06/12 14:58:02 rgrimes Exp $";
