 ...
 *
 *
 *	@(#) $RCSfile: co_kbd.c,v $	$Revision: 1.1 $ (Contributed to 386bsd) $Date: 1993/06/12 14:58:02 $
 */
static char rcsid[] = "$Header: /a/cvs/386BSD/src/sys/i386/isa/codrv/Attic/co_kbd.c,v 1.1 1993/06/12 14:58:02 rgrimes Exp $";
