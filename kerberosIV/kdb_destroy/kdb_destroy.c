/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/kdb_destroy/kdb_destroy.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/kdb_destroy/kdb_destroy.c,v 1.1 1994/02/25 01:13:55 wollman Exp $";
#endif	lint
