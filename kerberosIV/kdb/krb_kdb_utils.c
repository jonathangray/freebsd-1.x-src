/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/kdb/krb_kdb_utils.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/kdb/krb_kdb_utils.c,v 1.1 1994/02/25 01:13:53 wollman Exp $";
#endif	lint
