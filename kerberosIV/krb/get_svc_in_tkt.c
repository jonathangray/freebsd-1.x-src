/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/get_svc_in_tkt.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/get_svc_in_tkt.c,v 1.1 1994/02/25 01:14:15 wollman Exp $";
#endif /* lint */
