/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/save_credentials.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/save_credentials.c,v 1.1 1994/02/25 01:14:26 wollman Exp $";
#endif /* lint */
