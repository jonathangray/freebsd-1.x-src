/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/krb_get_in_tkt.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/krb_get_in_tkt.c,v 1.1 1994/02/25 01:14:18 wollman Exp $";
#endif /* lint */
