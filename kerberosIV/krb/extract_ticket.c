/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/extract_ticket.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/extract_ticket.c,v 1.1 1994/02/25 01:14:12 wollman Exp $";
#endif /* lint */
