/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/create_auth_reply.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/create_auth_reply.c,v 1.1 1994/02/25 01:14:10 wollman Exp $";
#endif /* lint */
