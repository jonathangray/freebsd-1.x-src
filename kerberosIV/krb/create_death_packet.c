/*
 * $Source: /a/cvs/386BSD/src/kerberosIV/krb/create_death_packet.c,v $
 * $Author: wollman $
 *
...
"$Header: /a/cvs/386BSD/src/kerberosIV/krb/create_death_packet.c,v 1.1 1994/02/25 01:14:11 wollman Exp $";
#endif /* lint */
